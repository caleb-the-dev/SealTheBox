...
func draw_hand() -> Array                # draw up to 3 dice into hand; reshuffles discard into pool when fewer than 3 remain
...
| 2026-05-08 | draw_hand() reverted to draw-3 (was draw-2). Reshuffle threshold restored to < 3. Rationale: 2-dice draw made Weaken-type abilities too weak (near-guaranteed low rolls already). |
