...
|-----|------|---------|---------------|-------------|
| classic | 1–9 | 45 | 20 | 4 |
| low_evens | 2–8 | 35 | 17 | 4 |
| high_odds | 3,5,7,9,11 | 35 | 17 | 4 |

## Data Source
`data/boxes.csv` — parsed by BoxLibrary at startup. Columns: `id, name, tabs, win_threshold`. Tabs are semicolon-separated ints.
