...
- Tests: test_run_manager.gd (46 tests) + test_power_effects.gd (30 tests) + test_ability_library.gd (22 abilities) + test_case_manager.gd (15 tests) + test_crossroads.gd (8 tests) + test_tab_board.gd + test_dice_pool.gd + test_box_definition.gd + test_box_definitions.gd (28-box pool validation) + test_box_roll_modifiers.gd (6 modifiers + RoundManager integration) + test_box_win_conditions.gd (2 WIN conditions + round_limit override + RoundManager integration, 18 tests) pass headless.
