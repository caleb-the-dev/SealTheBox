...
- Tests: test_run_manager.gd (46 tests) + test_power_effects.gd (30 tests) + test_ability_library.gd (22 abilities) + test_case_manager.gd (10 tests) + test_crossroads.gd (8 tests) + test_texture_roller.gd (9 tests) + test_entity.gd (9 tests) pass headless
